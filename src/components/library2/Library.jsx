        ...
        <div className="flex gap-5 max-md:flex-col">
          ...
          >
            <div className="flex flex-col w-full max-md:mt-[0px] max-md:max-w-full">
              <div className="max-w-full w-[636px]">
                <div className="flex gap-[115px] max-md:flex-col mt-[15px]">
                  ...
                  <div className="flex flex-col ml-5 w-[79%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col items-start w-full max-md:mt-10">
                      ...
                      <div className="flex gap-7 self-stretch mt-10 text-base">
                        <div className="flex-auto my-auto text-black">
                          You can clear your reading history{" "}
                        </div>
                        <button className="px-3 py-2.5 text-white bg-red-600 rounded-xl">
                          Clear History
                        </button>
                      </div>
                    </div>
          ...
          >
            <div className="flex flex-col items-start px-px py-1 mt-20 w-full max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-10 gap-[10px] flex justify-center">
                ...
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/e5723c662e872cf537972ff268eac583b6d762739609066a4b322b709f6adfb8?placeholderIfAbsent=true&apiKey=8947fdbc91b3418387184c18824db628"></img>
              </div>
