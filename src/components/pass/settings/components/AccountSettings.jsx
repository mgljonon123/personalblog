  ...
  return (
    ...
    >
      <div className="flex flex-col items-start max-md:max-w-full">
                ...
                {accountFields.map((field, index) => (
                  ...
                  >
                    ...
                    <input
                      ...
                      className="overflow-hidden gap-2.5 self-stretch px-3 w-full bg-white rounded-lg border-gray-300 border-solid border-[3px] min-h-[44px] max-md:max-w-full"
                    />
                  </div>
                ))}
              </div>
        ...
        <button className="flex overflow-hidden flex-col justify-center px-12 py-3 w-32 max-w-full text-base font-bold leading-none text-center text-white whitespace-nowrap bg-indigo-900 rounded-lg border border-purple-50 border-solid max-md:px-5">
          Save
        </button>
      </div>
    </section>
