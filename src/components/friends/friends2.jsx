      ...
      <div className="w-[100%] h-[990px] relative bg-white  overflow-hidden">
        ...
        <div className="left-[222px] top-[208px] absolute justify-start items-center gap-[43px] inline-flex">
          <Link to={"/friends1"} element={<Friends1></Friends1>}>
            <div className="w-[123px] h-[38px] text-[#7f7f7f] text-xl font-normal font-['Poppins']">
              Followers
            </div>
          </Link>
          <div className="w-[125px] h-[38px] text-black text-xl font-normal font-['Poppins']">
            Following
          </div>
        ...
        <div className="w-[730px] h-[0px] left-[223px] top-[249px] absolute opacity-50 border border-black"></div>
        <div className="w-[122px] h-[0px] left-[372px] top-[249px] absolute border border-black"></div>
        ...
        <div className="w-[670.08px] h-[89.40px] left-[223.32px] top-[374.16px] absolute">
          ...
          <div className="w-[37.08px] h-[22.99px] left-[311.20px] top-[1.28px] absolute opacity-50 text-black text-xs font-normal font-['Poppins']">
            2.5M
          </div>
          <div className="w-[18.54px] h-[17.88px] left-[350.93px] top-[1.28px] absolute opacity-50  overflow-hidden" />
        </div>
        <div className="w-[670.08px] h-[89.40px] left-[222px] top-[483.99px] absolute">
          <div className="w-[72.84px] h-[70.24px] left-0 top-[19.16px] absolute bg-black rounded-full" />
          ...
          <div className="w-[37.08px] h-[22.99px] left-[217.18px] top-[1.28px] absolute opacity-50 text-black text-xs font-normal font-['Poppins']">
            2.5M
          </div>
          <div className="w-[18.54px] h-[17.88px] left-[256.91px] top-[1.28px] absolute opacity-50  overflow-hidden" />
        </div>
        <div className="w-[670.08px] h-[89.40px] left-[223.32px] top-[689.60px] absolute">
          <div className="w-[72.84px] h-[70.24px] left-0 top-[19.16px] absolute bg-black rounded-full" />
          ...
          <div className="w-[37.08px] h-[22.99px] left-[335.04px] top-[1.28px] absolute opacity-50 text-black text-xs font-normal font-['Poppins']">
            2.5M
          </div>
          <div className="w-[18.54px] h-[17.88px] left-[374.77px] top-[1.28px] absolute opacity-50  overflow-hidden" />
        </div>
        <div className="w-[39px] h-[0px] left-[226px] top-[337px] absolute border border-[#ff0000]"></div>
        <div className="w-16 h-[31px] left-[223px] top-[622px] absolute text-black text-base font-normal font-['Poppins']">
          Writer
        </div>
        <div className="w-[43px] h-[0px] left-[223px] top-[653px] absolute border border-[#ff0000]"></div>
